...
// A note from Jashank:
//
// This code is terribly written, and unfortunately a lot of real-world
// C is written in similar styles.  You should never attempt to parse
// HTML yourself, and you should always use a clear style.
//
// To parse HTML safely and correctly, you should use a real HTML parser
// (like html5ever), or, failing that, an XML parser (like libxml2).
//
// If you ever write code like this, we will be very disappointed in you.
//
